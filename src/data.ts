...
export const PORTFOLIO_DETAILS = [
  ...
  },
  {
    ...
    tagline: "AIGC全流程创作 / Prompt+Skill工作流 / 三区视觉提效\n主导AI短剧漫剧全链路创作,工作流提效约300%,账号累计获赞590万+",
  ...
  },
  {
    ...
    tagline: "UGC视频生态搭建 / 自动化SOP沉淀 / GMV增长\n独立搭建AIGC视频生态,SOP提效约120%,累计贡献GMV $30,000+",
  ...
  },
  {
    ...
    tagline: "核心版本品牌视觉 / 游戏影视化内容 / AIGC提效工作流\n参与《DNF:起源》等核心版本视觉,构建标准化AIGC提效工作流",
...
export const CATALOG_PORTFOLIO_DATA = [
  {
    id: "video",
    index: "01",
    name: "视频短片作品",
    ...
    projects: [
      ...
      },
      {
        ...
        coverImage: "/images/20260912020358914.webp",
        tags: ["国风奇幻", "夜景渲染", "光影粒子"],
        tools: ["Midjourney", "Runway Gen-3", "ACE"],
        client: "独立艺术短片项目",
        role: "导演 / 视觉概念 / 合成",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        cardTitle: "WUKONG'S 24H：adidas × 大圣 视觉企划",
      ...
      },
      {
        ...
        cardTitle: "2033 地球慵懒节：AIGC情绪营销企划",
        subtitle: "“给地球放个假吧！”",
      ...
      },
      {
        ...
        tags: ["非遗再造", "偏光仿真", "品牌全案"],
        tools: ["Stable Diffusion", "LibTV", "ACE"],
        client: "非遗创新中心推广项目",
        role: "品牌创意主策划",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        subtitle: "“六星齐聚，戏说南斗；星行有道，凡心可通。”",
        coverImage: "/images/20260623010922651.webp",
        tags: ["全案宣发", "流体招贴", "中式几何"],
        tools: ["Stable Diffusion", "可灵 AI", "ACE"],
        client: "小红书社区部",
        role: "联合视觉主创",
      ...
      },
      {
        ...
        subtitle: "“开吃啦！野餐日”复古橡胶软管卡通插画",
        coverImage: "/images/20260623012234708.webp",
        tags: ["概念绘卷", "扁平构成", "版式设计"],
        tools: ["Procreate", "LibTV", "ACE"],
        client: "学院毕业概念季",
        role: "核心概念画师",
        description: "“开吃啦！野餐日”",
        story: [
