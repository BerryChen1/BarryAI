...
export const CustomVideoPlayer: React.FC<CustomVideoPlayerProps> = ({ 
  ...
  return (
    <div 
      ref={containerRef}
      className={`group/player relative w-full ${
        aspectRatio === 'portrait' ? 'aspect-[9/16] rounded-2xl' : 'aspect-video rounded-3xl'
      } overflow-hidden border border-white/10 bg-black shadow-[0_0_50px_rgba(0,0,0,0.85)] select-none transition-all duration-300 ${
