        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 pl-1 md:pl-2 items-start">
          ...
          <div className="space-y-3 col-span-1">
            ...
            <div 
              ...
              onClick={() => openZoom(1)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809223905962.webp" alt="Step 1 提取排版范式" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
          ...
          <div className="space-y-3 col-span-1 md:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
              <div 
                ...
                onClick={() => openZoom(2)}
              >
                <img loading="lazy" decoding="async" src="/images/20260809223929810.webp" alt="Step 2 初稿测试 A" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              ...
              <div 
                ...
                onClick={() => openZoom(3)}
              >
                <img loading="lazy" decoding="async" src="/images/20260809224006618.webp" alt="Step 2 初稿测试 B" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
                <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-2.5 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                  {t("点击查看大图", "Click to Zoom")}
                </div>
              </div>
          ...
          <div className="space-y-3 col-span-1">
            ...
            <div 
              ...
              onClick={() => openZoom(4)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224137412.webp" alt="Step 3 风格锁定与材质降维" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
      ...
      <div className="space-y-6 pt-6 border-t border-white/5">
        ...
        <div className="space-y-8 pl-1 md:pl-2">
          ...
          <div className="space-y-3">
            ...
            <div className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10" onClick={() => openZoom(5)}>
              <img loading="lazy" decoding="async" src="/images/20260809224111423.webp" alt="Step 1 平行主理人设定" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
      ...
      <div className="space-y-6 pt-6 border-t border-white/5">
        ...
        <div className="space-y-8 pl-1 md:pl-2">
          ...
          <div className="space-y-3">
            ...
            <div className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10" onClick={() => openZoom(7)}>
              <img loading="lazy" decoding="async" src="/images/20260809224307248.webp" alt="Step 1 无限画布与全局调度" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10" onClick={() => openZoom(8)}>
              <img loading="lazy" decoding="async" src="/images/20260809224331975.webp" alt="Step 2 语义约束与物理干预" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-4">
              <div className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10" onClick={() => openZoom(9)}>
                <img loading="lazy" decoding="async" src="/images/20260809224405477.webp" alt="Step 3 结构逆向工程 线稿" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
                <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                  {t("点击查看大图", "Click to Zoom")}
                </div>
              </div>
              <div className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10" onClick={() => openZoom(10)}>
                <img loading="lazy" decoding="async" src="/images/20260809224432013.webp" alt="Step 3 结构逆向工程 三维白模" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
                <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                  {t("点击查看大图", "Click to Zoom")}
                </div>
              </div>
        ...
        <div className="space-y-8 pl-1 md:pl-2">
          ...
          <div className="space-y-3">
            ...
            <div 
              ...
              onClick={() => openZoom(11)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224543802.webp" alt="复合场景压力测试" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div 
              ...
              onClick={() => openZoom(12)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224603318.webp" alt="微观情绪渲染" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
        ...
        <div className="space-y-8 pl-1 md:pl-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-6 w-full">
              <div 
                ...
                onClick={() => openZoom(13)}
              >
                <img loading="lazy" decoding="async" src="/images/20260809224739445.webp" alt="Step 1 服饰样机 A" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
                <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-2.5 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                  {t("点击查看大图", "Click to Zoom")}
                </div>
              </div>
              <div 
                ...
                onClick={() => openZoom(14)}
              >
                <img loading="lazy" decoding="async" src="/images/20260809224653969.webp" alt="Step 1 服饰周边 B" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
                <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-2.5 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                  {t("点击查看大图", "Click to Zoom")}
                </div>
              </div>
            ...
            <div 
              className="group relative overflow-hidden bg-zinc-900 shadow-xl cursor-pointer w-full rounded-none border border-white/10 mt-4"
              onClick={() => openZoom(15)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224848320.webp" alt="Step 1 服饰全资产展示板" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div 
              ...
              onClick={() => openZoom(16)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224926227.webp" alt="Step 2 多色滑板与手机壳全家福" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div 
              ...
              onClick={() => openZoom(17)}
            >
              <img loading="lazy" decoding="async" src="/images/20260809224943401.webp" alt="Step 3 巨幅 LED 广告牌与地垫细节" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out" referrerPolicy="no-referrer" />
              <div className="absolute bottom-4 right-4 bg-black/70 border border-white/10 text-[10px] text-zinc-300 px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-sm">
                {t("点击查看大图", "Click to Zoom")}
              </div>
            </div>
